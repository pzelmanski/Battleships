...
namespace BattleshipsTests
{
    public class ShipCreationTests
    {
        ...
        {
            var result = Ship.TryCreate(Coordinates.CreateOrThrow(1, 1), GridDirection.Right, 4,
                new List<Ship>(), 1);
        ...
        {
            var result = Ship.TryCreate(Coordinates.CreateOrThrow(1, 1), GridDirection.Down, 4,
                new List<Ship>(), 1);
        ...
        {
            var result =
                Ship.TryCreate(Coordinates.CreateOrThrow(1, 1), GridDirection.Up, 4, new List<Ship>(), 1);
        ...
        {
            var collidingShip = Ship.TryCreate(Coordinates.CreateOrThrow(2, 1), GridDirection.Right, 4,
                new List<Ship>(), 1);
